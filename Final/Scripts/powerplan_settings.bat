...
Notes: Configuring powerplan for Clauber Vianna settings.
**************************************************-->
:EndComment
...
powercfg -setdcvalueindex 8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c e73a048d-bf27-4f12-9731-8b2076e8891f d8742dcb-3e6a-4b3c-b3fe-374623cdcf06 2
...
echo.
echo =======================================
echo Active Power Plan is High Performance.
echo =======================================
