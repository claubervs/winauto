...
#(To remove Farm Hero Saga app from all current accounts on PC)
Get-appxpackage -allusers *king.com.FarmHeroesSaga* | Remove-AppxPackage -AllUsers
#(To only remove Farm Hero Saga app from new accounts created afterwards)
...
#(To remove everything from king.com app from all current accounts on PC)
Get-appxpackage -allusers *king.com.* | Remove-AppxPackage -AllUsers
#(To only remove everything from king.com app from new accounts created afterwards)
Get-appxprovisionedpackage -online | where-object {$_.packagename -like '*king.com.*'} | remove-appxprovisionedpackage -online



#(To remove everything from SpotifyAB.SpotifyMusic app from all current accounts on PC)
Get-appxpackage -allusers *SpotifyAB.SpotifyMusic* | Remove-AppxPackage -AllUsers
#(To only remove everything from SpotifyAB.SpotifyMusic app from new accounts created afterwards)
...
#(To remove everything from Hulu app from all current accounts on PC)
Get-appxpackage -allusers *Hulu* | Remove-AppxPackage -AllUsers
#(To only remove everything from Hulu app from new accounts created afterwards)
Get-appxprovisionedpackage -online | where-object {$_.packagename -like '*Hulu*'} | remove-appxprovisionedpackage -online



#(To remove everything from Disney app from all current accounts on PC)
Get-appxpackage -allusers *Disney* | Remove-AppxPackage -AllUsers
#(To only remove everything from Disney app from new accounts created afterwards)
